    ...
    @foreach ($children as $child)
        <li style="list-style: none;">
            <div class="custom-control custom-checkbox mb-3">
                <input disabled type="checkbox" class="custom-control-input" id="{{ $child->id }}" name="permissions[]"
        ...
        @if ($child->children->isNotEmpty())
            @include('admin.role.detail-item', ['children' => $child->children, 'code' => $child->id])
        @endif
    @endforeach
</ul>
