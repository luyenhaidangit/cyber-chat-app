(function (s) {
    var pageUrl = $('link[rel="canonical"]').data("url");
    ("use strict");
    function t(e) {
        ...
        "light-mode-switch" === e
            ? (s("#dark-mode-switch").prop("checked", !1),
              ...
              s("#bootstrap-style").attr(
                  "href",
                  pageUrl + "assets-1/css/bootstrap.min.css"
              ),
              s("#app-style").attr(
                  "href",
                  pageUrl + "assets-1/css/app.min.css"
              ),
            ...
            ? (s("#light-mode-switch").prop("checked", !1),
              ...
              s("#bootstrap-style").attr(
                  "href",
                  pageUrl + "assets-1/css/bootstrap-dark.min.css"
              ),
              s("#app-style").attr(
                  "href",
                  pageUrl + "assets-1/css/app-dark.min.css"
              ),
            ...
            : 1 == s("#rtl-mode-switch").prop("checked") &&
              ...
              s("#app-style").attr(
                  "href",
                  pageUrl + "assets-1/css/app-rtl.min.css"
              ),
    ...
    s("#side-menu").metisMenu(),
        ...
        window.sessionStorage && (n = sessionStorage.getItem("is_visited"))
