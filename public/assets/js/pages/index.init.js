...
!(function () {
                ...
                document
                    ...
                    .forEach(function (s) {
                        s.addEventListener("click", function (e) {
                            (m = "users"), o();
                            var t =
                                s.querySelector("li .font-size-14").innerHTML;
                            (document.querySelector(
                                ".text-truncate .user-profile-show"
                            ).innerHTML = t),
                                (document.querySelector(
                      ...
                      s.querySelectorAll(".delete-item").forEach(function (e) {
                          ...
                          s
                              ...
                              .forEach(function (e) {
                                  e.addEventListener("click", function () {
                                      var e =
                                          s.childNodes[1].firstElementChild
                                              .firstElementChild
                                              .firstElementChild
                                              .firstElementChild.innerText;
        ...
        document
            ...
            .addEventListener("change", function () {
                var e = document.querySelector(".user-profile-image"),
                    t = document.querySelector(".profile-img-file-input")
                        .files[0],
                    a = new FileReader();
                a.addEventListener(
                    "load",
    ...
    function H(e, t, a, s, i) {
        ...
        if (null != t)
            ...
            for (
                l += '<div class="message-img mb-0">', T = 0;
                T < a.length;
                T++
            )
                l +=
        ...
        (t = e),
            (a = function (e, t) {
                ...
                null !== e
                    ...
                    y.querySelectorAll(".chat-list").forEach(function (e) {
                        e.querySelectorAll(".delete-image").forEach(function (
                            e
                        ) {
                            e.addEventListener("click", function () {
                                1 == e.closest(".message-img").childElementCount
                    ...
                    s.forEach(function (a) {
                        a.addEventListener("click", function () {
                            ...
                            var e =
                                a.closest(".ctext-wrap").children[0].children[0]
                                    .innerText;
                            document.querySelector(
                                ".replyCard .replymessage-block .flex-grow-1 .mb-0"
                            ).innerText = e;
