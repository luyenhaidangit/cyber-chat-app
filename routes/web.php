...
Route::group(['middleware' => 'guest'], function () {
    ...
    Route::get('/lock-screen', 'App\Http\Controllers\GuestController@lock_screen')->name('lock_screen');
    Route::get('/change-password', 'App\Http\Controllers\GuestController@change_password')->name('change_password');
